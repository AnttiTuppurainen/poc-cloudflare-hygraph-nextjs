...
export const metadata = {
  title: {
    template: '%s | POC for Cloudflare pages with Hygraph',
  },
  openGraph: {
    title: 'POC content',
    description: 'Next.js, Tailwind CSS, and Hygraph and Cloudflare Pages',
  }
}
            ...
            <div className="py-6 lg:py-8">
              ...
              <div className="sm:flex sm:items-center sm:justify-between">
                <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">
                  © 2024{' '}
                  <a href="https://siili.com/" className="hover:underline">
                    Siili Solutions
                  </a>
                  . All Rights Reserved.
                </span>
